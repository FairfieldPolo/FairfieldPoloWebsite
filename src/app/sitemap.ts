...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/club/tailgating`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
    { url: `${BASE_URL}/club/history`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/club/faqs`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
    ...
    { url: `${BASE_URL}/venue/grounds`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.75 },
    { url: `${BASE_URL}/venue/photo-shoots`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.75 },
    ...
    { url: `${BASE_URL}/learn/getting-started`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
